...
public class ColorEncoding
{
	...
	public static Color EncodeLayerAsColor(int layer)
	{
		...
		var uniqueColors = new Color[] {
			...
			"#7FC97F".ToColor(), "#BEAED4".ToColor(), "#FDC086".ToColor(), // 8
			"#FFFF99".ToColor(), "#386CB0".ToColor(), "#F0027F".ToColor(), //
			"#BF5B16".ToColor(), "#666666".ToColor(), "#58d692".ToColor(),"#00000000".ToColor()						// 15
		};
