...
public class ImageSynthesis : MonoBehaviour {
	...
	private void Save(string filenameWithoutExtension, string filenameExtension, int width, int height)
	{
		...
		Save(pass.camera, filenameWithoutExtension + "img" + filenameExtension, width, height, pass.supportsAntialiasing, pass.needsRescale);
		pass = capturePasses[2];
		Save(pass.camera, filenameWithoutExtension + "label" + filenameExtension, width, height, pass.supportsAntialiasing, pass.needsRescale);
		//foreach (var pass in capturePasses)
